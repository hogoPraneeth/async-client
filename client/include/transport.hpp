 ...
 * @brief: This file defines Transport interface (ABC). Transport interface
 * defines methods that needs to be implemented to in the aspect of connecting, * sendind, receiving and Keep-Alive.
 */
#include <string>
#include "status.hpp"

/**
 * @brief: Transport defines the beahivior that any underlying transport layer  * (TCP/UDP)  should implement.
 */
class Transport {
    public:
    /**
