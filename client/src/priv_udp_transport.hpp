/**
 * @file: priv_udp_transport.hpp
 * @author: Praneeth Patil
 * @brief: This file defines UDP Transport concrete class. UDPTransport
 * implementes Transport interface.
 */
#include "transport.hpp"

/**
 * @breif: UDPTransport implements Transport interface with UDP connectivity.
 * UDPTranspoprt holds all the aspects of a connectionless protocol. Each instance of a UDPTransport is analogous to a UDP
 * client.
 */
